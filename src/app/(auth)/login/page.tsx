    ...
    <div className="min-h-screen bg-surface-1 flex flex-col">
      ...
      <nav className="flex items-center justify-between px-6 h-16 border-b border-surface bg-surface-0">
        ...
        <span className="text-sm text-gray-500">
          No account?{" "}
          <Link href="/signup" className="text-gray-900 font-medium underline underline-offset-2 hover:text-blue-700 transition-colors">
            Sign up free
          </Link>
        </span>
      </nav>
        ...
        <div className="w-full max-w-[400px]">
          ...
          <div className="mb-8 text-center">
            ...
            <p className="text-[15px] text-gray-500">
              Sign in to your Neon workspace
            </p>
          </div>
              ...
              <div className="space-y-1.5">
                <div className="flex items-center justify-between">
                  ...
                  <Link
                    ...
                    className="text-[12px] text-gray-500 hover:text-blue-700 transition-colors"
                  >
                    Forgot password?
                  </Link>
                </div>
